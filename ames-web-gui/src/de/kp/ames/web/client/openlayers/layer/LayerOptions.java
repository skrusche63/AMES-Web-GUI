...
public class LayerOptions extends JSObjectWrapper {
	...
	/**
	 *
	 * @param projection - {@link see de.kp.freg.client.openlayers.MapOptions}
	 */
	...
	/**
	 *
	 * @param units - {@link see de.kp.freg.client.openlayers.MapOptions}
	 */
	...
	/**
	 *
	 * @param maxExtent - {@link see de.kp.freg.client.openlayers.MapOptions#setMaxExtent(Bounds)}
	 */
	...
	/**
	 *
	 * @param minExtent - {@link see de.kp.freg.client.openlayers.MapOptions#setMinExtent(Bounds)}
	 */
	...
	/**
	 *
	 * @param maxResolution - {@link see de.kp.freg.client.openlayers.MapOptions#setMaxResolution(float)}
	 */
	...
	/**
	 *
	 * @param minResolution - {@link see de.kp.freg.client.openlayers.MapOptions#setMinResolution(float)}
	 */
