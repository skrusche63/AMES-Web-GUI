 ...
 *
 * <SemanticAssist>
 *     #client #dialog #disclaimer #fnc #workshop #web
 * </SemanticAssist>
 *
 */
...
public class WorkshopDialog extends BaseDialog {

	private HTMLFlow flow;
	
	public WorkshopDialog(String html) {
		super("1st App Workshop", "Isn't it easy?");
		
		this.flow.setContents(html);
		
		this.setTitle("1st App Workshop");
