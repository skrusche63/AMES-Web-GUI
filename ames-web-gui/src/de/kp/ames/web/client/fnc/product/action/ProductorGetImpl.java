 ...
 *
 * <SemanticAssist>
 *     #action #client #fnc #get #product #productor #web
 * </SemanticAssist>
 *
 */
...
public class ProductorGetImpl extends GridGetImpl {
	 ...
	 * @param record
	 */
	public ProductorGetImpl(Grid grid, Record record) {
		super(grid, record);
	}
