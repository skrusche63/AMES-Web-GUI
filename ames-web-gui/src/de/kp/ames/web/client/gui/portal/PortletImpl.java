package de.kp.ames.web.client.gui.portal;
/**
...
public class PortletImpl extends Window implements Portlet { 
	...
	public PortletImpl(PortletConfig jConfig) {
	...
	public void build() {
		...
		String title = this.jConfiguration.get(PortletConfig.PORTLET_TITLE).isString().stringValue();
		this.setTitle(title);
